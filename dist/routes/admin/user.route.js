...
userRoute.post("/create", auth_middleware_1.default.auth, upload.single("avatar"), user_validate_1.default.createANewUserValidate, uploadCloud_middleware_1.default.uploadSingerField, user_controller_1.default.createANewUserPost);
userRoute.get("/update/:userId", auth_middleware_1.default.auth, user_controller_1.default.getAUserByIdGet);
userRoute.patch("/update/:userId", auth_middleware_1.default.auth, upload.single("avatar"), user_validate_1.default.updateAUserByIdValidate, uploadCloud_middleware_1.default.uploadSingerField, user_controller_1.default.updateAUserByIdPatch);
