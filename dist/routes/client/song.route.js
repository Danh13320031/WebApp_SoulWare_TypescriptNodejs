...
songRoute.get("/:topicSlug", auth_middleware_1.default.optionalAuth, song_controller_1.default.getAllSongGet);
songRoute.get("/detail/:songSlug", auth_middleware_1.default.optionalAuth, song_controller_1.default.getOneSongGet);
