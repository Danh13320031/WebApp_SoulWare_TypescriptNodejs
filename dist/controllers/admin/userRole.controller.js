...
const softRemoveUserRoleByIdPatch = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield userRole_model_1.default.findOneAndUpdate({ _id: userRoleId }, { deleted: true });
        res.status(http_status_codes_1.StatusCodes.OK).json({
            code: http_status_codes_1.StatusCodes.OK,
            status: "Success",
...
const updateMultiUserRolePatch = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let ids = [];
        let type = "";
        if (req.body.ids)
        ...
        switch (type) {
            case "status-active":
                yield userRole_model_1.default.updateMany({ _id: { $in: ids }, deleted: false }, { status: "active" });
                break;
            case "status-inactive":
                yield userRole_model_1.default.updateMany({ _id: { $in: ids }, deleted: false }, { status: "inactive" });
                break;
            case "soft-delete":
                yield userRole_model_1.default.updateMany({ _id: { $in: ids }, deleted: false }, { deleted: true });
                break;
            case "hard-delete":
                yield userRole_model_1.default.deleteMany({ _id: { $in: ids } });
                break;
            default:
                break;
        }
